...
> **Before creating the final submission tag, rerun all three commands against the exact commit being submitted and record the final results.**
...
1. Open Merchant Dashboard
        ↓
2. Show recovery KPIs
        ↓
3. Open Chaos Console
        ↓
4. Inject 25 synthetic payment failures
        ↓
5. Return to Merchant Dashboard
        ↓
6. Show newly created recovery cases
        ↓
7. Open a recovery case
        ↓
8. Show AI Recommendation
        ↓
9. Show Policy Decision
        ↓
10. Show Action
        ↓
...
12. Show Audit Trail
        ↓
13. Show Jaeger Trace
        ↓
14. Trigger AI Timeout
        ↓
15. Show deterministic fallback
        ↓
16. Trigger duplicate webhook
        ↓
17. Show idempotency
        ↓
18. Trigger prompt injection
        ↓
19. Show action blocked
```

### Core message for the demo

> **“I didn't want to build an AI demo around payments. I wanted to build a payment recovery system in which AI could be used safely.”**
...
Before creating the final submission tag:

```text
[ ] Repository is public
[ ] README reflects final implementation
...
[ ] Dashboard works
[ ] Simulation works
[ ] Injected cases appear in dashboard
[ ] Pagination works
[ ] Filters work
[ ] Approval count matches approval page
[ ] Webhooks page works
[ ] Audit trail works
[ ] Jaeger trace works
[ ] Reconciliation works
[ ] AI fallback works
[ ] Duplicate webhook demo works
[ ] Prompt-injection demo works
[ ] pnpm typecheck passes
[ ] pnpm build passes
[ ] pnpm vitest run passes
[ ] Final results updated in evidence
[ ] 5-minute video uploaded
[ ] GitHub About section updated
[ ] Final submission commit tagged
```
